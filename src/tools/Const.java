...
public class Const {
	...
	public static final String SQL_MERGE_SYSTEM_1 = "MERGE INTO GEN_SYSTEM A USING (SELECT {param1} as SYS_NO, '{param1}' "
	...
	public static final String SQL_MERGE_SYSTEM_2 = "MERGE INTO ADM_SYSTEM A USING (SELECT {param1} as SYS_NO FROM DUAL) B "
			+ " ON (A.SYS_NO = B.SYS_NO) WHEN NOT MATCHED THEN INSERT (SYS_NO) VALUES (B.SYS_NO)~~";
	public static final String SQL_MERGE_SYSTEM_3 = "MERGE INTO EOD_SYSTEMS A USING (SELECT {param1} as SYS_NO, 1 as STEP_COUNT FROM DUAL) B "
			+ " ON (A.SYS_NO = B.SYS_NO) WHEN NOT MATCHED THEN INSERT (SYS_NO, STEP_COUNT) VALUES (B.SYS_NO, B.STEP_COUNT)~~";
	public static final String SQL_MERGE_SYSTEM_4 = "MERGE INTO RAM_SYSTEMS A USING (SELECT {param1} as SYS_NO FROM DUAL) B "
			+ " ON (A.SYS_NO = B.SYS_NO) WHEN NOT MATCHED THEN INSERT (SYS_NO) VALUES (B.SYS_NO)~~";
